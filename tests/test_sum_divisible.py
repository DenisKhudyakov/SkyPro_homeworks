...
def test_sum_divisible() -> None:
    ...
    assert sum_divisible_by_3_or_5([15, 30, 45, 60, 99, 100, 10]) == sum([15, 30, 45, 60, 99, 100, 10])
    assert sum_divisible_by_3_or_5([15, 30, 45, 60, 99, 100, 10, 8, 7, 14]) == sum([15, 30, 45, 60, 99, 100, 10])
